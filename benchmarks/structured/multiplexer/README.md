...
This benchmark program is an implementation of a Quantum Multiplexer that
applies one of 2^(n-1) different `ry` rotations depending on the state of the
input register. The given size parameter `n` specifies the total number of
qubits used, including the target qubit.
